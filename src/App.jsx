  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F5F2EB", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      ...
      <div style={{ background: "#FBFAF6", border: "1px solid #ECE7DB", borderRadius: 16, padding: "48px 40px", maxWidth: 400, width: "100%", textAlign: "center" }}>
        ...
        <div style={{ fontSize: 11, color: "#9DB0A1", marginTop: 20, lineHeight: 1.6 }}>
          By continuing you agree to our{" "}
          <button onClick={() => setModal("terms")} style={{ background: "none", border: "none", color: "#6B8F84", cursor: "pointer", fontSize: 11, padding: 0, textDecoration: "underline", fontFamily: "inherit" }}>Terms of Service</button>
          {" "}and{" "}
          <button onClick={() => setModal("privacy")} style={{ background: "none", border: "none", color: "#6B8F84", cursor: "pointer", fontSize: 11, padding: 0, textDecoration: "underline", fontFamily: "inherit" }}>Privacy Policy</button>.
        </div>
        <div style={{ fontSize: 11, color: "#9DB0A1", marginTop: 8 }}>
