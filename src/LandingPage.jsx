      ...
      <section style={{ padding: "0 24px 80px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
          {[
            ...
            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none"><circle cx="10" cy="36" r="3.5" fill="#2E4A3D"/><circle cx="24" cy="24" r="6" fill="#2E4A3D"/><circle cx="41" cy="9" r="8.5" fill="#C2A06B"/></svg>, title: "Net worth trajectory", body: "Year-by-year net worth from today to life expectancy, combining super, property, savings, and investments in one view." },
            ...
            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none"><path d="M24 8 L41 30 L7 30 Z" fill="#2E4A3D"/><rect x="7" y="36" width="34" height="5" rx="2.5" fill="#2E4A3D"/></svg>, title: "Property & debt", body: "Model multiple investment properties, negative gearing, P&I vs IO loans, and debt-free projections alongside your retirement picture." },
            ...
            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none"><rect x="21" y="18" width="6" height="22" rx="3" fill="#2E4A3D"/><circle cx="24" cy="11" r="7" fill="#2E4A3D"/></svg>, title: "Action plan", body: "A categorised summary of your key modelling insights across retirement, super, tax, property, and cashflow, built from your numbers, not generic advice." },
          ].map(f => (
